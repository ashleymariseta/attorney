...
import { BookText, BrainCircuit, Calendar, ChevronDown, ChevronRight, Clock, Coins, FileSignature, FileText, GraduationCap, Home, KeyRound, Mail, Menu, Plus, Search, Settings, Sparkles, Users, Wallet, X } from 'lucide-react';
