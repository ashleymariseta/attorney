...
from .sse import channel_events, user_events  # noqa: E402

urlpatterns = [
    path('', include(router.urls)),
    path('channels/<int:channel_id>/events/', channel_events, name='channel-events'),
    path('me/events/', user_events, name='user-events'),
    ...
    path('transactions/export.pdf', TransactionsExportPdfView.as_view(), name='transactions-export-pdf'),
